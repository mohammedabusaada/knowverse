    ...
    <div class="flex flex-col sm:flex-row sm:items-center gap-6 md:gap-8 mb-10">
        ...
        <div class="flex-1">
            <h1 class="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight flex items-center gap-3">
                ...
                {{-- Banned Badge --}}
                @if($user->isBanned())
                    <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-xs font-black bg-red-100 text-red-700 border border-red-200 dark:bg-red-900/30 dark:text-red-400 dark:border-red-800 uppercase tracking-widest shadow-sm">
