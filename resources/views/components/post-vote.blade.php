...
>
    ...
    <button
        @click="voteAction(1)"
        :class="vote === 1
            ? 'text-blue-700 bg-blue-600/10 border-blue-600/30 dark:text-blue-300 dark:bg-blue-500/20 dark:border-blue-500/30'
            : 'text-gray-500 hover:text-gray-900 bg-white hover:bg-gray-50 border-gray-200 dark:text-gray-400 dark:hover:text-gray-100 dark:bg-gray-900 dark:hover:bg-gray-800 dark:border-gray-800'"
    ...
    <span
        ...
        class="text-base font-semibold text-gray-900 dark:text-gray-100 transition-all duration-300"
    ></span>
