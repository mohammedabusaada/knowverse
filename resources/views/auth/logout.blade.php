    ...
    <div class="flex w-full md:w-1/2 justify-center items-center bg-white px-8 py-12">
        <div class="max-w-md w-full bg-white p-10 rounded-3xl shadow-2xl border border-gray-100 hover:shadow-gray-300/40 transition-shadow duration-300 text-center">
            ...
            <div class="flex flex-col space-y-4">
                <a
                    href="{{ route('login') }}"
                    class="block w-full bg-[#1a1a1a] hover:bg-gray-900 text-white font-semibold py-3 rounded-full shadow-md hover:shadow-lg transition"
                >
                    Sign In Again
                </a>
            ...
            <p class="mt-8 text-sm text-gray-500">
                Having trouble?
                <a href="{{ route('password.request') }}" class="font-medium text-gray-800 hover:underline">
                    Reset your password
                </a>
            </p>
